...
public class ConfirmPayment extends AppCompatActivity {
    ...
    Button btn_confirm_payment_payco;
    Button btn_confirm_payment_toss;
    Button aa;
    ...
    CheckBox checkPeoplePayingCheckbox;
    ...
    public void createListDialog(){
        ...
        alert.setAdapter(adapter, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int position) {
                ...
                Toast.makeText(ConfirmPayment.this, menu, Toast.LENGTH_SHORT).show();
            }
        });
        alert.show();
    }
