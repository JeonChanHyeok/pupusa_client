...
public class ChatRoomListAdapter extends BaseAdapter {
    ...
    ArrayList<ChatRoomListData> sample;

    public ChatRoomListAdapter(Context context, ArrayList<ChatRoomListData> data) {
        mContext = context;
        sample = data;
    ...
    @Override
    public ChatRoomListData getItem(int position) {
