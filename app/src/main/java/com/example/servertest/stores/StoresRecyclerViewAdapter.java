...
public class StoresRecyclerViewAdapter extends RecyclerView.Adapter<StoresRecyclerViewAdapter.ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            txt_main = (TextView) itemView.findViewById(R.id.tv_store_select);
        }
    }

    private ArrayList<StoresRecyclerViewItem> mList = null;

    public StoresRecyclerViewAdapter(ArrayList<StoresRecyclerViewItem> mList) {
        this.mList = mList;
    }
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.txt_main.setText(item.getSubText());
    }
