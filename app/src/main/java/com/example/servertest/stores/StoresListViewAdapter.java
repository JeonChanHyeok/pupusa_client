...
public class StoresListViewAdapter extends BaseAdapter {
    ArrayList<StoresListViewItem> itemList = new ArrayList<StoresListViewItem>();
    public StoresListViewAdapter(){
    }
    //오버라이딩해서 list값을 받는다.
    @Override // 몇개인지 확인
    public int getCount() {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView == null){
            ...
            convertView = inflater.inflate(R.layout.list_store, parent, false);
        }
        ...
        StoresListViewItem listitem = itemList.get(pos);
