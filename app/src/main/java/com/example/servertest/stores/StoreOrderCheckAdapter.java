...
public class StoreOrderCheckAdapter extends BaseAdapter {
    ListView listView;
    Button button;

    private ArrayList<StoreOrderCheckItem> orderCheckItemList = new ArrayList<>();

    public StoreOrderCheckAdapter(){}
