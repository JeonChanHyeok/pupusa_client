package com.example.servertest.map;
...
public class Map_Main extends AppCompatActivity implements MapView.CurrentLocationEventListener, MapReverseGeoCoder.ReverseGeoCodingResultListener, MapView.MapViewEventListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button fab = findViewById(R.id.floatingButton_show_current_location);
        Button select_loc = (Button) findViewById(R.id.btn_select_location);
        ...
        return_address.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("address", global_address);
    ...
    public void onCurrentLocationUpdate(MapView mapView, MapPoint currentLocation, float accuracyInMeters) {
        ...
        global_address = getCompleteAddressString(this, mapPointGeo.latitude, mapPointGeo.longitude);
    }
    @Override
